...
struct SegmentTreeLazy
{
    ...
    ll mergeThem(ll a, ll b)
    { //funcion de mezcla
        return a + b;
    }
    void init(int i, int l, int r, vector<ll> &arr)
    ...
    ll get(int a, int b)
    {              //Responder queries simbolicamente publico
        if (a > b) //Caso ciclico
